...
`https://drive.google.com/drive/folders/1i6mZ713QtN0hnvIX3N_csloXMLIR-6gH`.
...
channel browser-playable on itch.io. The Web PCK is checked against an 8 MB cap;
...
resulting PCK stays below 8 MB so an accidental return to an all-resources
export is visible.
